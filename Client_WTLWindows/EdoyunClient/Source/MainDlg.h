...
class CMainDlg :
	...
	//菜单的变化，子窗口的变化 BEGIN_UPDATE_UI_MAP和END_UPDATE_UI_MAP之间的消息
	public CUpdateUI<CMainDlg>,
	public CMessageFilter,//PreTranslateMessage
	public CIdleHandler  //OnIdle
{
public:
	CMainDlg(void);
	~CMainDlg(void);
