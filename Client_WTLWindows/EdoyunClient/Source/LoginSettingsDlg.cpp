...
void CLoginSettingsDlg::OnBtn_OK(UINT uNotifyCode, int nID, CWindow wndCtl)
{
	...
	{
		::MessageBox(m_hWnd, _T("聊天服务地址不能为空！"), _T("EdoyunIMClient"), MB_OK|MB_ICONINFORMATION);
	...
	{
		::MessageBox(m_hWnd, _T("文件服务地址不能为空！"), _T("EdoyunIMClient"), MB_OK|MB_ICONINFORMATION);
	...
	{
		::MessageBox(m_hWnd, _T("聊天端口号不能为空！"), _T("EdoyunIMClient"), MB_OK|MB_ICONINFORMATION);
	...
	{
		::MessageBox(m_hWnd, _T("文件端口号不能为空！"), _T("EdoyunIMClient"), MB_OK|MB_ICONINFORMATION);
	...
	if(nCurSel > USE_BROWSER_PROXY)			
	{
		...
		{
			::MessageBox(m_hWnd, _T("代理服务器地址不能为空！"), _T("EdoyunIMClient"), MB_OK|MB_ICONINFORMATION);
		...
		{
			::MessageBox(m_hWnd, _T("代理端口号不能为空！"), _T("EdoyunIMClient"), MB_OK|MB_ICONINFORMATION);
